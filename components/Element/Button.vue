...
const fillColor = computed(() => {
    if (props.disabled) return 'fill-gray-400'
    return 'fill-blue-600'
})

const classes = computed(() => {
    return {
        'btn relative whitespace-nowrap font-medium rounded text-sm px-4 py-2 flex items-center justify-center border': true,
